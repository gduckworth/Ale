...
/* ========================================================================= */
	/*	Archnav Filtering Hook
	/* =========================================================================  */

	var archnav_item = $('.archnav-items-wrapper');
	if (archnav_item.length) {
		var mixer = mixitup(archnav_item);
...
/* add initialise for individual tabs on phil */
